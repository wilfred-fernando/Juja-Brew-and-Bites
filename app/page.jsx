    ...
    <div className="min-h-screen bg-white" style={{ fontFamily:"'Inter',system-ui,sans-serif" }}>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#FFF5F7]">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto pt-24 pb-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="inline-flex items-center gap-2.5 mb-7 px-5 py-2 rounded-full text-[10px] font-bold uppercase tracking-[0.3em] bg-white text-[#FC687D] border border-rose-100 shadow-sm">
          ...
          <p className="text-rose-400 text-sm font-bold mb-12 tracking-wide">
            📍 36D Visayas Ave., Pasong Tamo, QC &nbsp;·&nbsp; Open 10AM – 12MN
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/order"
              className="px-10 py-4 rounded-full font-bold text-sm uppercase tracking-widest text-white hover:-translate-y-1 transition-all duration-300 bg-[#FC687D] shadow-[0_12px_30px_rgba(252,104,125,0.3)]">
              Order Online →
            </Link>
            <Link href="/menu"
              className="px-10 py-4 rounded-full font-bold text-sm uppercase tracking-widest bg-white text-slate-700 border border-slate-200 hover:border-[#FC687D] hover:text-[#FC687D] hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
              View Full Menu
            </Link>
          </div>
        </div>
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <p className="text-[#FC687D] uppercase tracking-[0.3em] text-[10px] font-bold mb-3">What We Serve</p>
          ...
          <div className="text-center mt-12">
            <Link href="/menu"
              className="inline-flex items-center gap-2 px-8 py-3.5 rounded-full bg-slate-50 text-slate-700 font-bold text-xs uppercase tracking-widest hover:bg-[#FC687D] hover:text-white hover:shadow-lg transition-all duration-300">
              View Full Menu →
            </Link>
          </div>
        </div>
      ...
      {featured.length > 0 && (
        <section className="py-24 px-6 bg-[#FFF5F7]">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <p className="text-[#FC687D] uppercase tracking-[0.3em] text-[10px] font-bold mb-3">Staff Picks</p>
      ...
      <section className="py-24 px-6 relative overflow-hidden bg-white border-t border-rose-50">
        <div className="relative max-w-4xl mx-auto text-center mb-14">
          <p className="text-[#FC687D] uppercase tracking-[0.3em] text-[10px] font-bold mb-3">Visit Us</p>
        ...
        <div className="relative max-w-4xl mx-auto grid sm:grid-cols-3 gap-6 mb-14">
          {[
            ...
            <div key={h.label} className="text-center p-8 rounded-3xl bg-[#FFF5F7] border border-rose-50 hover:shadow-md transition-all duration-300">
              ...
              <p className="text-slate-500 text-[10px] font-bold uppercase tracking-[0.2em] mb-2">{h.label}</p>
        ...
        <div className="relative flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <Link href="/promo"
            className="px-12 py-4 rounded-full font-bold text-sm uppercase tracking-widest transition-all duration-300 hover:-translate-y-1 bg-white text-slate-700 border border-slate-200 hover:border-[#FC687D] hover:text-[#FC687D]">
            View Promos 🎁
          </Link>
        </div>
      </section>
  ...
  return (
    <div
      ...
      <div className="relative overflow-hidden m-2 rounded-2xl flex-shrink-0" style={{ height:"210px" }}>
        ...
        {item.is_featured && (
          <div className="absolute top-3 left-3 px-3 py-1.5 rounded-full text-[9px] font-black uppercase tracking-widest text-white bg-[#FC687D] shadow-md">
            ✦ Must Try
          </div>
        )}
        ...
        <div className="absolute bottom-4 inset-x-0 flex justify-center"
          ...
          <Link href="/order"
            className="px-6 py-2.5 rounded-full text-xs font-black uppercase tracking-widest bg-white text-[#FC687D]
      ...
      <div className="p-6 flex flex-col flex-1">
        <div className="flex justify-between items-start gap-2 mb-2">
          ...
          <span className="font-black text-[#FC687D] text-lg flex-shrink-0">₱{item.price}</span>
        </div>
        {item.description && (
