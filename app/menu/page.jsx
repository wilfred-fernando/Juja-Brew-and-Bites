...
function Footer() {
  return (
    <footer className="bg-slate-900 text-slate-400 py-3 md:py-4 px-6 flex-none">
      ...
      <div className="max-w-7xl mx-auto pt-3 border-t border-white/10 flex flex-col sm:flex-row justify-between items-center text-white/60 text-[10px] tracking-wider uppercase">
