export const ADMIN_ACCESS_PAGES = [
  ...
  { key: "gift_certificates", label: "e-GC Monitoring", path: "/admin/gift-certificates", group: "Business" },
  { key: "promos", label: "Promos", path: "/admin/promos", group: "Business" },
  { key: "messenger", label: "Messenger", path: "/admin/messenger", group: "Business" },
