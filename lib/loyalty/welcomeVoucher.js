export const WELCOME_VOUCHER_REWARD_TEXT = "BUY 1 GET 1 16oz Cheesecake Milk Tea (Welcome Voucher)";
...
export async function createWelcomeVoucherIfNeeded(supabase, memberId) {
  ...
  if ((existing || []).some(isWelcomeVoucher)) return { created: 0, skipped: "exists" };
